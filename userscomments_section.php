				...
				<div class="container-fluid ml-2 mx-auto" style="width: 95%; border-radius: 13px">
			    	...
			    	<div class="media border m-1 p-3 shadow text-secondary">
			        	...
			        	<div class="mb-3">
				          ...
				          <a href="#" class="m-2 text-secondary"><i class="fa fa-thumbs-o-down"></i></a>
				          <a href="#" class="m-2 text-secondary">Reply</a>
				          <a href="#" class="m-2 text-secondary"><span class="fa fa-thumbs-up"></span></a>
								  <a href="#" class="m-2 text-secondary"><span class="fa fa-thumbs-down"></span></a>
								  <a href="#" class="m-2 text-secondary"><span class="">Approve Comment</span></a>
								  <a href="#" class="m-2 text-secondary"><span class="fa fa-trash m-3">Remove Comment</span></a>
				      	</div>
