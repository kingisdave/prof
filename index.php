		...
		<div class="col-md-8 col-11 mx-auto">
				<div class="card border-0 shadow-lg mt-1" id="mycol">
					<div class="card-body">
						...
						<p id="texttwo" class="greetingText m-2 mt-1 text-center">Razaq Olatunde Rom Kalilu</p>
		...
		<div class="col-lg-8 col-md-8 col-12 mx-auto">
			<div class="row pb-4" id="manycarousels">
				<div class="col-lg-4 col-md-4 col-sm-6 col-12">
					<!-- carousel -->
					<div id="demoone" class="carousel slide shadow" data-ride="carousel">
					  <!-- The slideshow -->
					  <div class="carousel-inner">
					    <div class="carousel-item active">
					      <img src="./assets/images/kal/img/RK_142X172_1426539309.png" class="img-thumbnail" alt="Los Angeles" width="550px" height="300" />
					    </div>
					    <div class="carousel-item">
					      <img src="./assets/images/kal/img/RK_142X172_1426539309.png" class="img-thumbnail" alt="Los Angeles" width="550px" height="300" />
					    </div>
					    ...
					    <div class="carousel-item">
					      <img src="./assets/images/kal/img/RK_142X172_1426539309.png" class="img-thumbnail" alt="Los Angeles" width="550px" height="350" />
					    </div>
					  </div>

					  <!-- Left and right controls -->
					  <a class="carousel-control-prev" href="#demoone" data-slide="prev">
					    <span class="carousel-control-prev-icon"></span>
					  </a>
					  <a class="carousel-control-next" href="#demoone" data-slide="next">
					    <span class="carousel-control-next-icon"></span>
					  </a>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-12">
					<div id="demotwo" class="carousel slide shadow" data-ride="carousel">

					  <!-- The slideshow -->
					  <div class="carousel-inner">
					    <div class="carousel-item active">
					      <img src="./assets/images/kal/img/RK_142X172_1426538432.png" class="img-thumbnail" alt="Chicago" width="550" height="350" />
					    </div>
					    <div class="carousel-item">
					      <img src="./assets/images/kal/img/RK_142X172_1426538432.png" class="img-thumbnail" alt="Chicago" width="550" height="350" />
					    </div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-12">
					<div id="demothree" class="carousel slide shadow" data-ride="carousel">

					  <!-- The slideshow -->
					  <div class="carousel-inner">
					    <div class="carousel-item active">
					      <img src="./assets/images/kal/img/RK_142X172_1426539336.png" class="img-thumbnail" alt="New York" width="550" height="350" />
					    </div>
					    <div class="carousel-item">
					      <img src="./assets/images/kal/img/RK_142X172_1426539336.png" class="img-thumbnail" alt="New York" width="550" height="350" />
					    </div>
					  ...
					  <!-- Left and right controls -->
					  <a class="carousel-control-prev" href="#demothree" data-slide="prev">
					    <span class="carousel-control-prev-icon"></span>
					  </a>
					  <a class="carousel-control-next" href="#demothree" data-slide="next">
					    <span class="carousel-control-next-icon"></span>
					  </a>
	...
	<!-- <div class="row">
        ...
        <div class="bookContainer"> -->
         ...
         <!--     <div class="page pagecontent page5">
            ...
            <div class="page pagecontent page4">
                Thus far you're doing good, you're on the fourth page
              <p style="position: relative; top: 160px;">- 4 -</p>
            </div>


            <div class="page pagecontent page3">
                Yeah! That's right you just got to the third page
              <p style="position: relative; top: 160px;">- 3 -</p>
            </div>

            <div class="page pagecontent page2">
              And this, the second page
              <p style="position: relative; top: 160px;">- 2 -</p>
            </div>

            <div class="page pagecontent page1">
              This must be the first page, please continue without tearing any page thanks
              <p style="position: relative; top: 160px;">- 1 -</p>
            </div>
          </div> --><!--book -->
