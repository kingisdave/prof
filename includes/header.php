...
<!-- Navigation Bar-->
	<div>
		...
		<!-- <div class=" float-right"> -->
			<nav class="navbar navbar-expand-md bg-dark navbar-dark w-75 float-right sticky-top" id="navbarimg">
					...
					<ul class="navbar-nav ml-auto">
				     ...
				     <!--  <a class="nav-link dropdown-toggle text-white" href="#" id="navbardrop" data-toggle="dropdown">
				      ...
				      <div class="dropdown-menu">
				        <a class="dropdown-item dropright">
									<a class="dropdown-item" href="#" id="navbardrop" data-toggle="dropdown">
				        		Art Gallery
				        	</a>
				        ...
				        <a class="dropdown-item" href="#">Exhibition Hall</a>
				      </div>
				    </li> 
				      ...
				      <div class="dropdown-menu">
						...
						<!-- <li class="nav-item mr-2"><a class="nav-link text-white" href="#">Profile</a></li> -->
						<li class="nav-item dropdown mr-2">
				      <a class="nav-link dropdown-toggle text-white" href="#" id="navbardrop" data-toggle="dropdown">
				        Profile
				      </a>
	...
	<!-- <script type="text/javascript" src="./js/fxn.js"></script> -->
</body>
</html>