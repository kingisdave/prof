...
<body>
	<div class="sidenav" id="mySidenav">
		<div class="container-fluid text-white">
		    ...
		    <!-- <li class="nav-item">
	      	<a class="nav-link row" href="profile.php"><span class="col-2 fa fa-info"></span><span class="col-10 small">My Dashboard</span></a> 
		    </li> -->
		     <li class="nav-item">
		    ...
		    <li class="nav-item dropdown dropright">
		     	<a class="nav-link row dropdown-toggle" data-toggle="dropdown" href="#"><span class="col-2 fa fa-users"></span><span class="col-10 small small">Uploads</span></a>
		     	<div class="dropdown-menu" style="color: #282923">
		      	...
		      	<a class="dropdown-item text-dark" href="./assessment_upload.php">News Board</a>
		      	<a class="dropdown-item text-dark" href="./curriculum.php">Curriculum Vitae</a>
		      	<a class="dropdown-item text-dark" href="./multimedia-upload.php">Multimedia</a>
			    </div>
		    </li>
		    <!-- <li class="nav-item">
