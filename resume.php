				...
				<div class="card-body">
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-4 col-6 mt-2">
							<div class="thumbnail">
								<a href="assets/images/dust.png" target="_blank">
									<img src="assets/images/dust.png" width="100%">
								</a>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-4 col-6 mt-2">
			...
			<div class="card">
				<div class="card-body">
					<div class="text-center">
						<span class="h2 m-3">
							<a href="#" class="fa fa-facebook-f m-4"></a>
							<a href="#" class="fa fa-linkedin-in m-4"></a>
							<a href="#" class="fa fa-instagram m-4"></a>
							<a href="#" class="fa fa-twitter m-4"></a>
						</span>
					</div>
				</div>
			</div>
